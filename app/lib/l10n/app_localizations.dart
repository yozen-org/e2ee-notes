...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Save the vault key on this device?'**
  String get saveVaultKeyQuestion;

  /// No description provided for @saveVaultKeyHardware.
  ///
  /// In en, this message translates to:
  /// **'Use this device\'s hardware to protect the key that unlocks your notes.'**
  String get saveVaultKeyHardware;

  /// No description provided for @saveVaultKeySoftware.
  ///
  /// In en, this message translates to:
